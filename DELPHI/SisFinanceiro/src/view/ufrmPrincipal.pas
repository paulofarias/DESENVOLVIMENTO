...
uses
  System.ImageList, Vcl.ImgList, Vcl.Controls, System.Classes, System.Actions,
  Vcl.ActnList, Vcl.Menus, Vcl.ExtCtrls, Vcl.ComCtrls, Vcl.Forms;
...
uses
  Winapi.Windows, System.SysUtils, uFrmSplash, uFrmLogin, uSistema;
...
const
  C_MSG_SAIR = 'Deseja realmente sair?';
begin
  if Application.MessageBox(
    C_MSG_SAIR,'Informação', MB_YESNO + MB_ICONQUESTION) = mrYes then
    Application.Terminate
  else
    Abort;
end;
