...
// (DO NOT EDIT: machine generated header) 'Schecklistbox.pas' rev: 11.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TCheckChanging)(System::TObject* Sender, int AItemIndex, Stdctrls::TCheckBoxState ANewState, bool &ChangingAllowed);
