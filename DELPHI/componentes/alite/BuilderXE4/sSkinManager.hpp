...
// (DO NOT EDIT: machine generated header) 'sSkinManager.pas' rev: 25.00 (Windows)
...
extern DELPHI_PACKAGE int __cdecl asSkinDecode(const TacCharArray &PackedData, __int64 *Keys, const int Keys_Size, const int Length, const int FormSum, /* out */ int &FilesCount, /* out */ int &Offset);
}	/* namespace Sskinmanager */
