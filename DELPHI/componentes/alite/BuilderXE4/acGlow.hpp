...
// (DO NOT EDIT: machine generated header) 'acGlow.pas' rev: 25.00 (Windows)
...
extern DELPHI_PACKAGE int __fastcall ShowGlow(const System::Types::TRect &RealRect, int const *MaskIndexes, const int MaskIndexes_Size, const int Margin, const int Alpha, HWND WndHandle, Scommondata::TsCommonData* SkinData = (Scommondata::TsCommonData*)(0x0))/* overload */;
