...
extern PACKAGE void __fastcall UpdateCorners(Scommondata::TsCommonData* SkinData, int State, TsCorners Corners = (System::Set<TsCorner, scLeftTop, scRightBottom> () << TsCorner(0) << TsCorner(1) << TsCorner(2) << TsCorner(3) ));
