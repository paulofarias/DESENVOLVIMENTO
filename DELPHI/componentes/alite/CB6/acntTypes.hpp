...
// (DO NOT EDIT: machine generated header) 'acntTypes.pas' rev: 6.00
...
__published:
	__property Graphics::TColor Color1 = {read=FColor1, write=SetColor, index=0, default=-2147483633};
	__property Graphics::TColor Color2 = {read=FColor2, write=SetColor, index=1, default=-2147483626};
	__property Graphics::TColor FontColor = {read=FFontColor, write=SetColor, index=2, default=-2147483630};
	__property Graphics::TColor BorderColor = {read=FBorderColor, write=SetColor, index=3, default=-2147483638};
public:
	#pragma option push -w-inl
...
__published:
	__property Color1  = {index=0, default=-2147483628};
	__property Color2  = {index=1, default=-2147483633};
public:
	#pragma option push -w-inl
...
__published:
	__property Color1  = {index=0, default=-2147483626};
	__property Color2  = {index=1, default=-2147483626};
public:
	#pragma option push -w-inl
