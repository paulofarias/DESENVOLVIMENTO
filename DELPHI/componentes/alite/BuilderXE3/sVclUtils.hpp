...
// (DO NOT EDIT: machine generated header) 'sVclUtils.pas' rev: 24.00 (Windows)
...
extern DELPHI_PACKAGE Vcl::Controls::THintWindow* __fastcall acShowHintWnd(const System::UnicodeString HintText, const System::Types::TPoint &Pos _ANNOT_ATTR_NC);
extern DELPHI_PACKAGE System::Types::TRect __fastcall acWorkRect(Vcl::Forms::TForm* Form)/* overload */;
extern DELPHI_PACKAGE System::Types::TRect __fastcall acWorkRect(const System::Types::TPoint &Coord _ANNOT_ATTR_NC)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall PaintControls(HDC DC, Vcl::Controls::TWinControl* OwnerControl, bool ChangeCache, const System::Types::TPoint &Offset _ANNOT_ATTR_NC, bool CheckVisible = true);
