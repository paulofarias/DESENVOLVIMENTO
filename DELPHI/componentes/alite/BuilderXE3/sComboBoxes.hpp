...
// (DO NOT EDIT: machine generated header) 'sComboBoxes.pas' rev: 24.00 (Windows)
...
protected:
	...
	virtual bool __fastcall DrawSkinItem(int aIndex, const System::Types::TRect &aRect _ANNOT_ATTR_NC, Winapi::Windows::TOwnerDrawState aState, HDC aDC);
