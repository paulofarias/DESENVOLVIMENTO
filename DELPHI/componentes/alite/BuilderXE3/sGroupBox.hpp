...
// (DO NOT EDIT: machine generated header) 'sGroupBox.pas' rev: 24.00 (Windows)
...
protected:
	...
	void __fastcall PaintCaptionArea(const System::Types::TRect &cRect _ANNOT_ATTR_NC, const Sconst::TCacheInfo &CI, int AState);
	...
	void __fastcall PaintCheckBoxSkin(Vcl::Graphics::TBitmap* Bmp, const System::Types::TRect &R _ANNOT_ATTR_NC, int State);
	void __fastcall PaintCheckBoxStd(HDC DC, const System::Types::TRect &R _ANNOT_ATTR_NC, int State);
