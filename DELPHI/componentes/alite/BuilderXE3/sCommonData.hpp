...
// (DO NOT EDIT: machine generated header) 'sCommonData.pas' rev: 24.00 (Windows)
...
public:
	...
	void __fastcall PaintOuterEffects(Vcl::Controls::TWinControl* OwnerCtrl, const System::Types::TPoint &Offset _ANNOT_ATTR_NC);
...
extern DELPHI_PACKAGE void __fastcall InitIndexes(TsCommonData* const SkinData, System::UnicodeString const *Sections, const int Sections_Size);
