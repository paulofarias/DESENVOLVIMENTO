...
// (DO NOT EDIT: machine generated header) 'acTitleBar.pas' rev: 24.00 (Windows)
...
typedef void __fastcall (__closure *TacInternalDrawEvent)(TacTitleBarItem* Item, System::Types::TRect &R, Vcl::Graphics::TBitmap* Bmp);
...
typedef void __fastcall (__closure *TacDrawItemEvent)(TacTitleBarItem* Item, TacTitleItemDrawData &ADrawData);
