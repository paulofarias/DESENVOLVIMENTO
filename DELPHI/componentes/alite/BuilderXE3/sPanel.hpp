...
// (DO NOT EDIT: machine generated header) 'sPanel.pas' rev: 24.00 (Windows)
...
public:
	...
	virtual void __fastcall WriteText(const System::Types::TRect &R _ANNOT_ATTR_NC, Vcl::Graphics::TCanvas* aCanvas = (Vcl::Graphics::TCanvas*)(0x0), HDC aDC = (HDC)(0x0));
...
public:
	...
	int __fastcall GetItemByCoord(const System::Types::TPoint &p _ANNOT_ATTR_NC);
	virtual void __fastcall WndProc(Winapi::Messages::TMessage &Message);
	DYNAMIC void __fastcall MouseDown(System::Uitypes::TMouseButton Button, System::Classes::TShiftState Shift, int X, int Y);
...
public:
	...
	virtual bool __fastcall PrepareCache(void);
	virtual void __fastcall WndProc(Winapi::Messages::TMessage &Message);
	void __fastcall WriteText(const System::Types::TRect &R _ANNOT_ATTR_NC, Vcl::Graphics::TCanvas* aCanvas = (Vcl::Graphics::TCanvas*)(0x0), HDC aDC = (HDC)(0x0));
	virtual void __fastcall PaintWindow(HDC DC);
