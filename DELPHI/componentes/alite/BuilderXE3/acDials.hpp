...
// (DO NOT EDIT: machine generated header) 'acDials.pas' rev: 24.00 (Windows)
...
protected:
	...
	bool __fastcall AboveBorder(const Winapi::Messages::TWMNCHitTest &Message _ANNOT_ATTR_NC);
