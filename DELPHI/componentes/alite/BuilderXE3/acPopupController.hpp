...
// (DO NOT EDIT: machine generated header) 'acPopupController.pas' rev: 24.00 (Windows)
...
protected:
	...
	void __fastcall ShowFormPos(Vcl::Forms::TForm* AForm, const System::Types::TPoint &ALeftTop _ANNOT_ATTR_NC, bool Animated = true);
...
extern DELPHI_PACKAGE void __fastcall ShowPopupForm(Vcl::Forms::TForm* AForm, const System::Types::TPoint &ALeftTop _ANNOT_ATTR_NC, bool Animated = true)/* overload */;
