...
// (DO NOT EDIT: machine generated header) 'acSBUtils.pas' rev: 24.00 (Windows)
...
protected:
	...
	void __fastcall DoDrawText(const System::Types::TRect &Rect _ANNOT_ATTR_NC, int Flags);
...
protected:
	...
	void __fastcall PaintTick(const System::Types::TPoint &P _ANNOT_ATTR_NC, bool Horz);
...
protected:
	...
	void __fastcall DrawBtn(const int Index, const System::Types::TRect &R _ANNOT_ATTR_NC, const HDC DC);
...
protected:
	...
	System::Types::TRect __fastcall CaptionRect(void);
	void __fastcall PrepareCache(void);
	void __fastcall WriteText(const System::Types::TRect &R _ANNOT_ATTR_NC);
	void __fastcall AC_WMPaint(const Winapi::Messages::TWMPaint &Message _ANNOT_ATTR_NC);
	virtual void __fastcall acWndProc(Winapi::Messages::TMessage &Message);
public:
...
protected:
	...
	void __fastcall PrepareCache(void);
	void __fastcall AC_WMPaint(const Winapi::Messages::TWMPaint &Message _ANNOT_ATTR_NC);
	void __fastcall AC_WMNCPaint(const Winapi::Messages::TWMPaint &Message _ANNOT_ATTR_NC);
	virtual void __fastcall acWndProc(Winapi::Messages::TMessage &Message);
public:
...
protected:
	...
	void __fastcall WriteText(const System::Types::TRect &R _ANNOT_ATTR_NC, Vcl::Graphics::TCanvas* aCanvas = (Vcl::Graphics::TCanvas*)(0x0));
	virtual void __fastcall acWndProc(Winapi::Messages::TMessage &Message);
...
protected:
	...
	virtual void __fastcall SaveStdParams(void);
	virtual void __fastcall RestoreStdParams(void);
	void __fastcall ColumnSkinPaint(const System::Types::TRect &ControlRect _ANNOT_ATTR_NC, int cIndex, HDC DC);
...
protected:
	...
	void __fastcall DrawItem(int Index, const System::Types::TRect &Rect _ANNOT_ATTR_NC, Winapi::Windows::TOwnerDrawState State, HDC DC);
	virtual void __fastcall acWndProc(Winapi::Messages::TMessage &Message);
...
protected:
	...
	void __fastcall DrawSkinTab(int Index, int State, Vcl::Graphics::TBitmap* Bmp, const System::Types::TPoint &OffsetPoint _ANNOT_ATTR_NC)/* overload */;
...
protected:
	...
	int __fastcall IndexByMouse(const System::Types::TPoint &MousePos _ANNOT_ATTR_NC);
...
extern DELPHI_PACKAGE void __fastcall ac_DrawScrollBtn(const System::Types::TRect &bRect _ANNOT_ATTR_NC, int State, Vcl::Graphics::TBitmap* Bmp, Sskinmanager::TacSkinData* sd, Sconst::TacSide Side);
extern DELPHI_PACKAGE void __fastcall ac_DrawSlider(const System::Types::TRect &bRect _ANNOT_ATTR_NC, int State, Vcl::Graphics::TBitmap* Bmp, Sskinmanager::TacSkinData* sd, bool Vert);
...
extern DELPHI_PACKAGE System::Types::TRect __fastcall BtnDrawRect(const System::Types::TRect &R _ANNOT_ATTR_NC, Sskinmanager::TacSkinData* sd, Sconst::TacSide Side);
}	/* namespace Acsbutils */
