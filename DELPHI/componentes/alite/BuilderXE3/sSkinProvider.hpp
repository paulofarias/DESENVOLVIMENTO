...
// (DO NOT EDIT: machine generated header) 'sSkinProvider.pas' rev: 24.00 (Windows)
...
public:
	...
	void __fastcall DoHook(Vcl::Controls::TWinControl* Control, const Acsbutils::TacSkinParams &SkinParams _ANNOT_ATTR_NC);
};
...
protected:
	...
	void __fastcall SendToAdapter(const Winapi::Messages::TMessage &Message _ANNOT_ATTR_NC);
	bool __fastcall HeaderUsed(void);
	void __fastcall PaintForm(HDC DC, const System::Types::TRect &PaintRect _ANNOT_ATTR_NC, bool SendUpdated = true);
	void __fastcall PaintCaption(HDC DC);
	void __fastcall PaintTitleContent(int CaptWidth);
	void __fastcall PaintTitleItem(Actitlebar::TacTitleBarItem* Item, const System::Types::TRect &R _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* Bmp);
	void __fastcall UpdateLayerForm(void);
	void __fastcall RepaintButton(int i);
	void __fastcall RepaintMenuItem(Vcl::Menus::TMenuItem* mi, const System::Types::TRect &R _ANNOT_ATTR_NC, Winapi::Windows::TOwnerDrawState State);
	...
	System::Types::TRect __fastcall LimitRect(int db, const System::Types::TRect &R _ANNOT_ATTR_NC, bool Invert = false);
	System::Types::TSize __fastcall CheckEdges(const System::Types::TRect &rStatic _ANNOT_ATTR_NC, const System::Types::TRect &rDynamic _ANNOT_ATTR_NC, int NewX, int NewY);
...
protected:
	...
	bool __fastcall MouseAboveTheShadow(const Winapi::Messages::TWMMouse &Message _ANNOT_ATTR_NC);
