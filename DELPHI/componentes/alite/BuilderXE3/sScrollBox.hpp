...
// (DO NOT EDIT: machine generated header) 'sScrollBox.pas' rev: 24.00 (Windows)
...
public:
	...
	DYNAMIC bool __fastcall DoMouseWheel(System::Classes::TShiftState Shift, int WheelDelta, const System::Types::TPoint &MousePos _ANNOT_ATTR_NC);
