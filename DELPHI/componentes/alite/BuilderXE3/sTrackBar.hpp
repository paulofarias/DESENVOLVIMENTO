...
// (DO NOT EDIT: machine generated header) 'sTrackBar.pas' rev: 24.00 (Windows)
...
protected:
	...
	void __fastcall PaintProgress(const System::Types::TRect &R _ANNOT_ATTR_NC, bool Horz);
	...
	void __fastcall SetPosByMouse(const System::Types::TPoint &p _ANNOT_ATTR_NC);
...
public:
	...
	TAPoint __fastcall TicksArray(const System::Types::TRect &ChRect _ANNOT_ATTR_NC);
...
protected:
	...
	void __fastcall PaintTicksVer(void);
	void __fastcall PaintTick(const System::Types::TPoint &P _ANNOT_ATTR_NC, bool Horz);
	void __fastcall PaintRange(const System::Types::TRect &R _ANNOT_ATTR_NC, bool Horz);
	...
	System::Types::TRect __fastcall RangeRect(const System::Types::TRect &aRect _ANNOT_ATTR_NC);
	TAPoint __fastcall InitTicksArray(const System::Types::TRect &ChRect _ANNOT_ATTR_NC);
