...
// (DO NOT EDIT: machine generated header) 'sListView.pas' rev: 24.00 (Windows)
...
protected:
	...
	NativeUInt __fastcall MakeDragImage(const Winapi::Messages::TMessage &Message _ANNOT_ATTR_NC);
