...
// (DO NOT EDIT: machine generated header) 'sButton.pas' rev: 24.00 (Windows)
...
protected:
	...
	void __fastcall DrawGlyph(const Acnttypes::TacColoring &ColorTones _ANNOT_ATTR_NC, Vcl::Graphics::TCanvas* Canvas = (Vcl::Graphics::TCanvas*)(0x0));
