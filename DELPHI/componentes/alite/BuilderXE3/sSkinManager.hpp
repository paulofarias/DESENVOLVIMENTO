...
// (DO NOT EDIT: machine generated header) 'sSkinManager.pas' rev: 24.00 (Windows)
...
protected:
	...
	int __fastcall MakeNewItem(int SkinIndex, const System::UnicodeString PropertyName, const System::UnicodeString AClassName, Sconst::TacImgType ImgType, const System::Types::TRect &R _ANNOT_ATTR_NC, int Count, int DrawMode, short Masktype);
...
typedef void __fastcall (__closure *TScaleChangeEvent)(System::TObject* Sended, TScaleChangeData &ScaleChangeData);
...
extern DELPHI_PACKAGE int __cdecl asSkinDecode(char *PackedData, __int64 *Keys, const int Keys_Size, const int Length, const int FormSum, /* out */ int &FilesCount, /* out */ int &Offset);
}	/* namespace Sskinmanager */
