...
// (DO NOT EDIT: machine generated header) 'acThdTimer.pas' rev: 24.00 (Windows)
...
public:
	...
	void __fastcall CopyFrom(Vcl::Graphics::TBitmap* &DstBmp, Vcl::Graphics::TBitmap* SrcBmp, const System::Types::TRect &R _ANNOT_ATTR_NC);
