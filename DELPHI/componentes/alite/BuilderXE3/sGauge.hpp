...
// (DO NOT EDIT: machine generated header) 'sGauge.pas' rev: 24.00 (Windows)
...
private:
	...
	void __fastcall PaintAsText(Vcl::Graphics::TBitmap* AnImage, const System::Types::TRect &PaintRect _ANNOT_ATTR_NC);
	void __fastcall PaintAsNothing(Vcl::Graphics::TBitmap* AnImage, const System::Types::TRect &PaintRect _ANNOT_ATTR_NC);
	void __fastcall PaintAsBar(Vcl::Graphics::TBitmap* AnImage, const System::Types::TRect &PaintRect _ANNOT_ATTR_NC);
	void __fastcall PaintAsPie(Vcl::Graphics::TBitmap* AnImage, const System::Types::TRect &PaintRect _ANNOT_ATTR_NC);
	void __fastcall PaintAsNeedle(Vcl::Graphics::TBitmap* AnImage, const System::Types::TRect &PaintRect _ANNOT_ATTR_NC);
	void __fastcall SkinPaintAsText(const System::Types::TRect &aRect _ANNOT_ATTR_NC);
	void __fastcall SkinPaintAsBar(const System::Types::TRect &aRect _ANNOT_ATTR_NC);
	void __fastcall SkinPaintAsPie(const System::Types::TRect &aRect _ANNOT_ATTR_NC);
	void __fastcall SkinPaintAsNeedle(const System::Types::TRect &aRect _ANNOT_ATTR_NC);
	void __fastcall SkinPaintBody(const System::Types::TRect &aRect _ANNOT_ATTR_NC);
