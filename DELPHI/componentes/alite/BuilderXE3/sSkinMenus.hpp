...
// (DO NOT EDIT: machine generated header) 'sSkinMenus.pas' rev: 24.00 (Windows)
...
typedef void __fastcall (__closure *TsMenuManagerDrawItemEvent)(System::TObject* Sender, Vcl::Graphics::TCanvas* ACanvas, System::Types::TRect &ARect, Winapi::Windows::TOwnerDrawState State, TsMenuItemType ItemType);
...
protected:
	...
	void __fastcall PaintDivider(Vcl::Graphics::TCanvas* aCanvas, const System::Types::TRect &aRect _ANNOT_ATTR_NC, Vcl::Menus::TMenuItem* Item, Vcl::Graphics::TBitmap* MenuBmp, const PacMenuInfo mi);
	void __fastcall PaintCaption(Vcl::Graphics::TCanvas* aCanvas, const System::Types::TRect &aRect _ANNOT_ATTR_NC, Vcl::Menus::TMenuItem* Item, Vcl::Graphics::TBitmap* BG, const PacMenuInfo mi);
	bool __fastcall IsRTL(Vcl::Menus::TMenuItem* Item);
	bool __fastcall IsDivText(Vcl::Menus::TMenuItem* Item);
	System::Types::TRect __fastcall ItemRect(Vcl::Menus::TMenuItem* Item, const System::Types::TRect &aRect _ANNOT_ATTR_NC);
	...
	void __fastcall sAdvancedDrawItem(System::TObject* Sender, Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect _ANNOT_ATTR_NC, Winapi::Windows::TOwnerDrawState State);
	...
	void __fastcall sAdvancedDrawLineItem(System::TObject* Sender, Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect _ANNOT_ATTR_NC, Winapi::Windows::TOwnerDrawState State);
