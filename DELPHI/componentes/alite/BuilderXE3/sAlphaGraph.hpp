...
// (DO NOT EDIT: machine generated header) 'sAlphaGraph.pas' rev: 24.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall WriteColor(Vcl::Graphics::TBitmap* const Bmp, System::WideChar * Text, bool Enabled, const System::Types::TRect &lRect _ANNOT_ATTR_NC, unsigned Flags, System::Uitypes::TColor Color, bool IsAnsi = false);
extern DELPHI_PACKAGE void __fastcall WriteColorW(Vcl::Graphics::TBitmap* const Bmp, const System::WideString Text, bool Enabled, const System::Types::TRect &lRect _ANNOT_ATTR_NC, unsigned Flags, System::Uitypes::TColor Color);
...
extern DELPHI_PACKAGE void __fastcall BlendColorRect(Vcl::Graphics::TBitmap* Bmp, const System::Types::TRect &R _ANNOT_ATTR_NC, System::Byte Blend, System::Uitypes::TColor Color)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall FillRect32(Vcl::Graphics::TBitmap* const Bmp, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Uitypes::TColor Color, System::Byte Alpha = (System::Byte)(0xff));
extern DELPHI_PACKAGE void __fastcall FillRect32Excl(Vcl::Graphics::TBitmap* const Bmp, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TRect &ExcludeR _ANNOT_ATTR_NC, const System::Uitypes::TColor Color, System::Byte Alpha = (System::Byte)(0xff));
extern DELPHI_PACKAGE void __fastcall FillAlphaRect(Vcl::Graphics::TBitmap* const Bmp, const System::Types::TRect &R _ANNOT_ATTR_NC, System::Byte Value, System::Uitypes::TColor TransparentColor = (System::Uitypes::TColor)(0x1fffffff));
extern DELPHI_PACKAGE void __fastcall CheckEmptyAChannel(Vcl::Graphics::TBitmap* Bmp);
extern DELPHI_PACKAGE void __fastcall BmpDisabledKind(Vcl::Graphics::TBitmap* const Bmp, const Sconst::TsDisabledKind DisabledKind, Vcl::Controls::TControl* Parent, const Sconst::TCacheInfo &CI, const System::Types::TPoint &Offset _ANNOT_ATTR_NC);
extern DELPHI_PACKAGE void __fastcall DrawSmallSkinRect(Vcl::Graphics::TBitmap* Bmp, const System::Types::TRect &aRect _ANNOT_ATTR_NC, const Sconst::TCacheInfo &ci, const Smaskdata::TsMaskData &MaskData, int State);
...
extern DELPHI_PACKAGE void __fastcall CopyMasterRect(const System::Types::TRect &R1 _ANNOT_ATTR_NC, const System::Types::TRect &R2 _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* const aBmp, const Sconst::TCacheInfo &CI, const Smaskdata::TsMaskData &MaskData);
extern DELPHI_PACKAGE void __fastcall CopyByMask32(const System::Types::TRect &R1 _ANNOT_ATTR_NC, const System::Types::TRect &R2 _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* const Bmp1, Vcl::Graphics::TBitmap* const Bmp2, const Sconst::TCacheInfo &CI, const Smaskdata::TsMaskData &MaskData);
extern DELPHI_PACKAGE void __fastcall CopyByMask32Ex(const System::Types::TRect &R1 _ANNOT_ATTR_NC, const System::Types::TRect &R2 _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* Bmp1, Vcl::Graphics::TBitmap* Bmp2, const Sconst::TCacheInfo &CI, const Smaskdata::TsMaskData &MaskData, int Opacity);
extern DELPHI_PACKAGE void __fastcall DrawSkinGlyph(Vcl::Graphics::TBitmap* Bmp, const System::Types::TPoint &P _ANNOT_ATTR_NC, int State, int AddedTransparency, const Smaskdata::TsMaskData &MaskData, const Sconst::TCacheInfo &CI);
...
extern DELPHI_PACKAGE void __fastcall BlendGlyphByMask(const System::Types::TRect &R1 _ANNOT_ATTR_NC, const System::Types::TRect &R2 _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* Bmp1, Vcl::Graphics::TBitmap* Bmp2, int TransparencyMode, const Smaskdata::TsMaskData &MaskData);
...
extern DELPHI_PACKAGE void __fastcall PaintItem32(int SkinIndex, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, System::TObject* CommonSkinData)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItemBG32(int SkinIndex, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, System::TObject* CommonSkinData, System::Uitypes::TColor CustomColor = (System::Uitypes::TColor)(0xff00ff));
...
extern DELPHI_PACKAGE void __fastcall DrawSkinRect32Ex(Vcl::Graphics::TBitmap* aBmp, const System::Types::TRect &aRect, const Sconst::TCacheInfo &ci, const Smaskdata::TsMaskData &MaskData, const int State, const System::Types::TRect &MaxWidths _ANNOT_ATTR_NC, int Opacity);
}	/* namespace Salphagraph */
