...
// (DO NOT EDIT: machine generated header) 'acntUtils.pas' rev: 24.00 (Windows)
...
extern DELPHI_PACKAGE bool __fastcall RectInRect(const System::Types::TRect &BigRect _ANNOT_ATTR_NC, const System::Types::TRect &SmallRect _ANNOT_ATTR_NC, bool FullInclude = true);
extern DELPHI_PACKAGE System::Types::TRect __fastcall RotateRect(const System::Types::TRect &R _ANNOT_ATTR_NC, bool Clockwise = true, int ParentWidth = 0x0);
...
extern DELPHI_PACKAGE void __fastcall AddPadding(System::Types::TRect &R, const System::Types::TRect &Padding _ANNOT_ATTR_NC);
...
extern DELPHI_PACKAGE bool __fastcall acCharIn(const System::WideChar C, const System::Sysutils::TSysCharSet &SysCharSet _ANNOT_ATTR_NC);
extern DELPHI_PACKAGE int __fastcall acWordPosition(const int N, const System::UnicodeString S, const System::Sysutils::TSysCharSet &WordDelims _ANNOT_ATTR_NC);
extern DELPHI_PACKAGE int __fastcall GetWordNumber(const System::UnicodeString W, const System::UnicodeString S, const System::Sysutils::TSysCharSet &WordDelims _ANNOT_ATTR_NC);
extern DELPHI_PACKAGE int __fastcall WordPosition(const int N, const System::AnsiString S, const System::Sysutils::TSysCharSet &WordDelims _ANNOT_ATTR_NC);
extern DELPHI_PACKAGE System::AnsiString __fastcall ExtractWord(const int N, const System::AnsiString S, const System::Sysutils::TSysCharSet &WordDelims _ANNOT_ATTR_NC);
extern DELPHI_PACKAGE System::UnicodeString __fastcall acExtractWord(const int N, const System::UnicodeString S, const System::Sysutils::TSysCharSet &WordDelims _ANNOT_ATTR_NC);
extern DELPHI_PACKAGE int __fastcall acWordCount(const System::UnicodeString S, const System::Sysutils::TSysCharSet &WordDelims _ANNOT_ATTR_NC);
extern DELPHI_PACKAGE int __fastcall WordCount(const System::AnsiString S, const System::Sysutils::TSysCharSet &WordDelims _ANNOT_ATTR_NC);
...
extern DELPHI_PACKAGE System::UnicodeString __fastcall ExtractSubStr(const System::AnsiString S, int &Pos, const System::Sysutils::TSysCharSet &Delims _ANNOT_ATTR_NC);
extern DELPHI_PACKAGE bool __fastcall IsEmptyStr(const System::AnsiString S, const System::Sysutils::TSysCharSet &EmptyChars _ANNOT_ATTR_NC);
...
extern DELPHI_PACKAGE void __fastcall InitSysProc(void);
