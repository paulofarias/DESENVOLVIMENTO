...
// (DO NOT EDIT: machine generated header) 'sCheckListBox.pas' rev: 24.00 (Windows)
...
private:
	...
	void __fastcall DrawCheck(const System::Types::TRect &R _ANNOT_ATTR_NC, Vcl::Stdctrls::TCheckBoxState AState, bool AEnabled, Vcl::Graphics::TBitmap* Bmp, const Sconst::TCacheInfo &CI)/* overload */;
	void __fastcall DrawCheck(const System::Types::TRect &R _ANNOT_ATTR_NC, Vcl::Stdctrls::TCheckBoxState AState, bool AEnabled, Vcl::Graphics::TCanvas* C)/* overload */;
...
protected:
	virtual void __fastcall DrawItem(int Index, const System::Types::TRect &Rect _ANNOT_ATTR_NC, Winapi::Windows::TOwnerDrawState State);
