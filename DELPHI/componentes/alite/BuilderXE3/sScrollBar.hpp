...
// (DO NOT EDIT: machine generated header) 'sScrollBar.pas' rev: 24.00 (Windows)
...
protected:
	...
	System::Types::TPoint __fastcall CoordToPoint(const System::Types::TPoint &p _ANNOT_ATTR_NC);
	int __fastcall CoordToPosition(const System::Types::TPoint &p _ANNOT_ATTR_NC);
