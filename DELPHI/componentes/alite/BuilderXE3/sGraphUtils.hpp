...
// (DO NOT EDIT: machine generated header) 'sGraphUtils.pas' rev: 24.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall DrawCloseBtn(HDC DC, const System::Types::TRect &R _ANNOT_ATTR_NC, int State);
extern DELPHI_PACKAGE void __fastcall DrawColorArrow(Vcl::Graphics::TCanvas* const Canvas, const System::Uitypes::TColor Color, const System::Types::TRect &R _ANNOT_ATTR_NC, const Sconst::TacSide Direction, int PPI)/* overload */;
extern DELPHI_PACKAGE void __fastcall DrawColorArrow(Vcl::Graphics::TBitmap* const aBmp, const System::Uitypes::TColor Color, const System::Types::TRect &R _ANNOT_ATTR_NC, const Sconst::TacSide Direction, int PPI)/* overload */;
extern DELPHI_PACKAGE void __fastcall DrawArrow(Vcl::Graphics::TBitmap* const aBmp, const System::Uitypes::TColor Color1, const System::Uitypes::TColor Color2, const System::Types::TRect &R _ANNOT_ATTR_NC, const Sconst::TacSide Direction, int LineWidth, int AngleShift, int ArrowSize, Acnttypes::TacArrowsStyle Style, int PPI = 0x60)/* overload */;
extern DELPHI_PACKAGE void __fastcall DrawArrow(HDC DC, const System::Uitypes::TColor Color1, const System::Uitypes::TColor Color2, const System::Types::TRect &R _ANNOT_ATTR_NC, const Sconst::TacSide Direction, int LineWidth, int AngleShift, int ArrowSize, Acnttypes::TacArrowsStyle Style, int PPI = 0x60)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall DrawBmp(Vcl::Graphics::TCanvas* ACanvas, Vcl::Graphics::TBitmap* Bmp, const System::Types::TRect &R _ANNOT_ATTR_NC, bool Reflected);
...
extern DELPHI_PACKAGE void __fastcall PaintItemBG(int SkinIndex, const Sconst::TCacheInfo &ci, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, System::Classes::TComponent* SkinManager, int TextureIndex = 0xffffffff, int HotTextureIndex = 0xffffffff, System::Uitypes::TColor CustomColor = (System::Uitypes::TColor)(0xff00ff))/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItemBG(int SkinIndex, const Sconst::TCacheInfo &ci, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, Acnttypes::TacObject* CommonSkinData, int TextureIndex = 0xffffffff, int HotTextureIndex = 0xffffffff, System::Uitypes::TColor CustomColor = (System::Uitypes::TColor)(0xff00ff))/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItemBGFast(int SkinIndex, int BGIndex, int BGHotIndex, const Sconst::TCacheInfo &ci, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, System::Classes::TComponent* SkinManager)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItemBGFast(int SkinIndex, int BGIndex, int BGHotIndex, const Sconst::TCacheInfo &ci, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, Acnttypes::TacObject* CommonSkinData)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItemFast(int SkinIndex, int MaskIndex, int BGIndex, int BGHotIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, System::Classes::TComponent* SkinManager)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItemFast(int SkinIndex, int MaskIndex, int BGIndex, int BGHotIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, Acnttypes::TacObject* CommonSkinData)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItem(int SkinIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, System::Classes::TComponent* SkinManager, int BGIndex = 0xffffffff, int BGHotIndex = 0xffffffff)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItem(int SkinIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, Acnttypes::TacObject* CommonSkinData, int BGIndex = 0xffffffff, int BGHotIndex = 0xffffffff)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItem(int SkinIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, Acnttypes::TacObject* CommonSkinData, const Smaskdata::TsMaskData &md _ANNOT_ATTR_NC)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItem(int SkinIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, HDC DC, System::Classes::TComponent* SkinManager)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItem(int SkinIndex, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, HDC DC, Acnttypes::TacObject* CommonSkinData)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintItemBG(Scommondata::TsCommonData* SkinData, const Sconst::TCacheInfo &ci, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, int OffsetX = 0x0, int OffsetY = 0x0)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall PaintItem(Scommondata::TsCommonData* SkinData, const Sconst::TCacheInfo &ci, bool Filling, int State, const System::Types::TRect &R _ANNOT_ATTR_NC, const System::Types::TPoint &pP _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* ItemBmp, bool UpdateCorners, int OffsetX = 0x0, int OffsetY = 0x0)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall CopyChannel32(Vcl::Graphics::TBitmap* const DstBmp, Vcl::Graphics::TBitmap* const SrcBmp, const int Channel, const System::Types::TRect &DstRect _ANNOT_ATTR_NC, const System::Types::TRect &SrcRect _ANNOT_ATTR_NC)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall DrawGlyphEx(Vcl::Graphics::TBitmap* Glyph, Vcl::Graphics::TBitmap* DstBmp, const System::Types::TRect &R _ANNOT_ATTR_NC, int NumGlyphs, bool Enabled, Sconst::TsDisabledGlyphKind DisabledGlyphKind, int State, int Blend, bool Down = false, bool Reflected = false);
...
extern DELPHI_PACKAGE void __fastcall PaintTransBG(Vcl::Graphics::TBitmap* Bmp, const System::Types::TRect &R _ANNOT_ATTR_NC, System::Uitypes::TColor Color1, System::Uitypes::TColor Color2, int Size);
...
extern DELPHI_PACKAGE void __fastcall acDrawGlowForText(Vcl::Graphics::TBitmap* const DstBmp, System::WideChar * Text, const System::Types::TRect &aRect _ANNOT_ATTR_NC, unsigned Flags, unsigned Side, int BlurSize, System::Uitypes::TColor Color, Vcl::Graphics::TBitmap* &MaskBmp);
...
extern DELPHI_PACKAGE void __fastcall FadeBmp(Vcl::Graphics::TBitmap* FadedBmp, const System::Types::TRect &aRect _ANNOT_ATTR_NC, int Transparency, const Sconst::TsColor Color, int Blur, int Radius);
extern DELPHI_PACKAGE void __fastcall BlendTransRectangle(Vcl::Graphics::TBitmap* Dst, int X, int Y, Vcl::Graphics::TBitmap* Src, const System::Types::TRect &aRect _ANNOT_ATTR_NC, System::Byte Blend, System::Uitypes::TColor TransColor = (System::Uitypes::TColor)(0xff00ff))/* overload */;
...
extern DELPHI_PACKAGE void __fastcall SumBmpRect(Vcl::Graphics::TBitmap* const DstBmp, Vcl::Graphics::TBitmap* const SrcBmp, const System::Byte AlphaValue, const System::Types::TRect &SrcRect _ANNOT_ATTR_NC, const System::Types::TPoint &DstPoint _ANNOT_ATTR_NC);
extern DELPHI_PACKAGE void __fastcall PaintBmpRect32(Vcl::Graphics::TBitmap* const DstBmp, Vcl::Graphics::TBitmap* const SrcBmp, const System::Types::TRect &SrcRect _ANNOT_ATTR_NC, const System::Types::TPoint &DstPoint _ANNOT_ATTR_NC, System::Byte SrcBlendValue = (System::Byte)(0xff));
...
extern DELPHI_PACKAGE void __fastcall CopyByMask(const System::Types::TRect &R1 _ANNOT_ATTR_NC, const System::Types::TRect &R2 _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* const Bmp1, Vcl::Graphics::TBitmap* const Bmp2, const Sconst::TCacheInfo &CI, const bool UpdateTrans)/* overload */;
extern DELPHI_PACKAGE void __fastcall CopyBmp32(const System::Types::TRect &R1 _ANNOT_ATTR_NC, const System::Types::TRect &R2 _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* const Bmp1, Vcl::Graphics::TBitmap* const Bmp2, const Sconst::TCacheInfo &CI, const bool UpdateTrans, System::Uitypes::TColor GrayedColor, const int Blend, const bool Reflected);
extern DELPHI_PACKAGE void __fastcall CopyByMask(const System::Types::TRect &R1 _ANNOT_ATTR_NC, const System::Types::TRect &R2 _ANNOT_ATTR_NC, Vcl::Graphics::TBitmap* const Bmp1, Vcl::Graphics::TBitmap* const Bmp2, const Sconst::TCacheInfo &CI, const bool UpdateTrans, const Smaskdata::TsMaskData &MaskData)/* overload */;
...
extern DELPHI_PACKAGE void __fastcall CopyTransRect(Vcl::Graphics::TBitmap* DstBmp, Vcl::Graphics::TBitmap* SrcBmp, int X, int Y, const System::Types::TRect &SrcRect _ANNOT_ATTR_NC, System::Uitypes::TColor TransColor, const Sconst::TCacheInfo &CI, bool UpdateTrans);
extern DELPHI_PACKAGE void __fastcall CopyTransRectA(Vcl::Graphics::TBitmap* DstBmp, Vcl::Graphics::TBitmap* SrcBmp, int X, int Y, const System::Types::TRect &SrcRect _ANNOT_ATTR_NC, System::Uitypes::TColor TransColor, const Sconst::TCacheInfo &CI _ANNOT_ATTR_NC, const int Blend = 0x0);
...
extern DELPHI_PACKAGE void __fastcall ColorizeByMask(Vcl::Graphics::TBitmap* const DstBmp, Vcl::Graphics::TBitmap* const MskBmp, const System::Types::TPoint &TopLeft _ANNOT_ATTR_NC, System::Uitypes::TColor Color, System::Uitypes::TColor BGColor);
...
extern DELPHI_PACKAGE void __fastcall BitBltRotated(HDC DC, Vcl::Graphics::TBitmap* SrcBmp, const System::Types::TPoint &ACenter _ANNOT_ATTR_NC, int Angle);
...
extern DELPHI_PACKAGE void __fastcall FocusRect(Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &R _ANNOT_ATTR_NC, System::Uitypes::TColor LightColor = (System::Uitypes::TColor)(0xff00000f), System::Uitypes::TColor DarkColor = (System::Uitypes::TColor)(0x0));
extern DELPHI_PACKAGE bool __fastcall FontsEqual(Vcl::Graphics::TFont* const Font1, Vcl::Graphics::TFont* const Font2);
extern DELPHI_PACKAGE void __fastcall acPaintStdBtn(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect _ANNOT_ATTR_NC, bool AEnabled, bool AFocusRect, int AState);
