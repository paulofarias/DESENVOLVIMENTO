...
// (DO NOT EDIT: machine generated header) 'sGradient.pas' rev: 24.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall PaintGrad(Vcl::Graphics::TBitmap* Bmp, const System::Types::TRect &aRect _ANNOT_ATTR_NC, const Sconst::TsGradArray Data, int OffsetX = 0x0, int OffsetY = 0x0)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintGrad(Vcl::Graphics::TBitmap* Bmp, const System::Types::TRect &aRect _ANNOT_ATTR_NC, const System::UnicodeString Gradient)/* overload */;
extern DELPHI_PACKAGE void __fastcall PaintGradTxt(Vcl::Graphics::TBitmap* Bmp, const System::Types::TRect &aRect _ANNOT_ATTR_NC, const Sconst::TsGradArray Data, Vcl::Graphics::TBitmap* TextureBmp, const System::Types::TRect &TextureRect _ANNOT_ATTR_NC, System::Byte TextureAlpha, System::Byte AlphaChannel = (System::Byte)(0xff));
