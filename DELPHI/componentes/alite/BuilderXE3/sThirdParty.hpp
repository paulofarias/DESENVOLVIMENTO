...
// (DO NOT EDIT: machine generated header) 'sThirdParty.pas' rev: 24.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall acDrawGlyphEx(const TacDrawGlyphData &DrawData _ANNOT_ATTR_NC);
