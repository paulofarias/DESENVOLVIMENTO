...
// (DO NOT EDIT: machine generated header) 'Svclutils.pas' rev: 10.00
...
extern PACKAGE Classes::TAlignment BidiAlign[2][3];
...
extern PACKAGE Controls::THintWindow* __fastcall acShowHintWnd(const AnsiString HintText, const Types::TPoint &Pos);
