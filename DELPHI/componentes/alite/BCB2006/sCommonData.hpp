...
// (DO NOT EDIT: machine generated header) 'Scommondata.pas' rev: 10.00
...
extern PACKAGE void __fastcall InitIndexes(const TsCommonData* SkinData, AnsiString const * Sections, const int Sections_Size);
