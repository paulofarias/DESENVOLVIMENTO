...
// (DO NOT EDIT: machine generated header) 'acntTypes.pas' rev: 33.00 (Windows)
...
public:
	/* TObject.Create */ inline __fastcall TacObject() : System::TObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TacObject() { }
...
public:
	int ImageIndex;
public:
	/* TObject.Create */ inline __fastcall TacItemDrawData() : TacObject() { }
	/* TObject.Destroy */ inline __fastcall virtual ~TacItemDrawData() { }
...
public:
	...
	/* TTimer.Destroy */ inline __fastcall virtual ~TacTimer() { }
...
public:
	...
	/* TControl.Destroy */ inline __fastcall virtual ~TacAccessControl() { }
...
public:
	HDC FHandle;
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacAccessCanvas() { }
	
public:
	/* TObject.Create */ inline __fastcall TacAccessCanvas() : Vcl::Graphics::TCustomCanvas() { }
...
public:
	...
	__fastcall virtual ~TacGlowForm();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacDataNormal() { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacDataActive() { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacDataPressed() { }
...
public:
	__fastcall TacPaintButtonOptions();
	TacDataNormal* __fastcall GetData(int State);
	__fastcall virtual ~TacPaintButtonOptions();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacPadding() { }
