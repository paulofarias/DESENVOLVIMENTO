...
// (DO NOT EDIT: machine generated header) 'acThdTimer.pas' rev: 33.00 (Windows)
...
public:
	/* TThread.Create */ inline __fastcall TacTimerThread()/* overload */ : System::Classes::TThread() { }
	/* TThread.Create */ inline __fastcall TacTimerThread(bool CreateSuspended)/* overload */ : System::Classes::TThread(CreateSuspended) { }
	/* TThread.Create */ inline __fastcall TacTimerThread(bool CreateSuspended, NativeUInt ReservedStackSize)/* overload */ : System::Classes::TThread(CreateSuspended, ReservedStackSize) { }
	/* TThread.Destroy */ inline __fastcall virtual ~TacTimerThread() { }
...
public:
	...
	__fastcall virtual ~TacThreadedTimer();
