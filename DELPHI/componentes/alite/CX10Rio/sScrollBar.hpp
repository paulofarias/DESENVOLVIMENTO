...
// (DO NOT EDIT: machine generated header) 'sScrollBar.pas' rev: 33.00 (Windows)
...
protected:
	...
	void __fastcall PrepareTimer();
	void __fastcall PrepareBtnTimer();
	void __fastcall PrepareBarTimer();
...
public:
	...
	__fastcall virtual ~TsScrollBar();
