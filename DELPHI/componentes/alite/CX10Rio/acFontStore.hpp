...
// (DO NOT EDIT: machine generated header) 'acFontStore.pas' rev: 33.00 (Windows)
...
public:
	/* TacEmbeddedFonts.Destroy */ inline __fastcall virtual ~TacFonts() { }
...
public:
	...
	__fastcall virtual ~TsFontStore();
