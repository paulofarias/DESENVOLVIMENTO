...
// (DO NOT EDIT: machine generated header) 'sGroupBox.pas' rev: 33.00 (Windows)
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TsMargin() { }
...
protected:
	...
	bool __fastcall ModernStyle();
	void __fastcall PaintCaptionArea(const System::Types::TRect &cRect, const Sconst::TCacheInfo &CI, int AState);
	void __fastcall InitPaintData();
	int __fastcall TextHeight();
	int __fastcall CheckBoxIndex();
	int __fastcall CheckBoxWidth();
	int __fastcall CheckBoxHeight();
	bool __fastcall MouseInCheckBox();
	virtual void __fastcall CheckBoxChanged();
