...
// (DO NOT EDIT: machine generated header) 'sVclUtils.pas' rev: 33.00 (Windows)
...
public:
	...
	__property Canvas;
public:
	/* TCustomControl.Destroy */ inline __fastcall virtual ~TOutputWindow() { }
...
public:
	/* TacDialogWnd.Destroy */ inline __fastcall virtual ~TacAccessDialogWnd() { }
...
protected:
	...
	void __fastcall Anim_Init();
	void __fastcall CallEvent();
	void __fastcall Anim_DoNext();
	bool __fastcall Anim_GoToNext();
...
public:
	...
	__fastcall virtual ~TacHideTimer();
public:
...
extern DELPHI_PACKAGE System::Types::TPoint __fastcall acMousePos();
...
extern DELPHI_PACKAGE Vcl::Controls::TControl* __fastcall CtrlUnderMouse();
...
extern DELPHI_PACKAGE int __fastcall DefaultPPI();
...
extern DELPHI_PACKAGE System::Classes::TShiftState __fastcall GetShiftState();
extern DELPHI_PACKAGE System::WideString __fastcall GetWndText(NativeUInt hwnd);
extern DELPHI_PACKAGE void __fastcall ResetLastError();
extern DELPHI_PACKAGE void __fastcall CheckLastError();
extern DELPHI_PACKAGE void __fastcall ReflectControls(Vcl::Controls::TWinControl* ParentWnd, bool Recursion);
extern DELPHI_PACKAGE bool __fastcall acThemesEnabled();
}	/* namespace Svclutils */
