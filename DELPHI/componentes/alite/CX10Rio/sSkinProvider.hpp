...
// (DO NOT EDIT: machine generated header) 'sSkinProvider.pas' rev: 33.00 (Windows)
...
public:
	...
	__fastcall virtual TacGraphItem();
	__fastcall virtual ~TacGraphItem();
...
public:
	...
	__fastcall virtual ~TacAdapterItem();
...
public:
	...
	bool __fastcall FontIsStored();
	__fastcall virtual TacAddedTitle();
	__fastcall virtual ~TacAddedTitle();
...
public:
	...
	__fastcall virtual ~TsTitleButton();
...
public:
	...
	__fastcall virtual ~TsTitleButtons();
...
public:
	...
	__fastcall virtual ~TsTitleIcon();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacSysSubMenu() { }
...
public:
	int __fastcall ScaledAddHeight();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacFormHeader() { }
...
private:
	...
	bool __fastcall HaveSysMenu();
	void __fastcall UpdateNCArea(bool Skinned);
	void __fastcall InitIndexes();
...
protected:
	...
	void __fastcall AdapterRemove();
	void __fastcall AdapterCreate();
	void __fastcall SendToAdapter(const Winapi::Messages::TMessage &Message);
	bool __fastcall HeaderUsed();
	...
	void __fastcall UpdateLayerForm();
	...
	void __fastcall AC_WMNCDestroy();
	...
	void __fastcall AC_WMNCPaintHandler();
	...
	bool __fastcall MDIButtonsNeeded();
	System::Types::TPoint __fastcall RBGripPoint(const int ImgIndex);
	System::Types::TPoint __fastcall FormLeftTop();
	int __fastcall SysButtonsCount();
	int __fastcall SmallButtonWidth();
	int __fastcall ButtonHeight();
	int __fastcall SmallButtonHeight();
	...
	void __fastcall UpdateSlaveFormsList();
	bool __fastcall UWPNoBorderMode();
	...
	bool __fastcall FormChanged();
	bool __fastcall IconVisible();
	System::UnicodeString __fastcall TitleSkinSection();
	void __fastcall TryInitMenu();
	...
	void __fastcall CalcItems();
	void __fastcall LoadInit();
	...
	int __fastcall CaptionWidth();
	int __fastcall MenuHeight();
	bool __fastcall MenuPresent();
	bool __fastcall SysRTLAllowed();
	System::Uitypes::TColor __fastcall FormColor();
...
public:
	...
	System::Types::TRect __fastcall UWPClientRect();
	...
	__fastcall virtual ~TsSkinProvider();
	System::Types::TRect __fastcall ShadowSize();
	void __fastcall RepaintMenu();
	bool __fastcall UpdateMenu();
...
public:
	...
	__fastcall virtual ~TacSBAnimation();
...
protected:
	...
	int __fastcall MinTopCoord();
	unsigned __fastcall FormState();
	void __fastcall UpdateRgn();
	...
	NativeUInt __fastcall GetTopWnd();
...
public:
	virtual bool __fastcall VisibleClose() = 0 ;
	virtual bool __fastcall VisibleMax() = 0 ;
	virtual bool __fastcall VisibleMin() = 0 ;
	virtual bool __fastcall EnabledMax() = 0 ;
	virtual bool __fastcall EnabledMin() = 0 ;
	virtual bool __fastcall EnabledRestore() = 0 ;
public:
	/* TPopupMenu.Create */ inline __fastcall virtual TsCustomSysMenu(System::Classes::TComponent* AOwner) : Vcl::Menus::TPopupMenu(AOwner) { }
	/* TPopupMenu.Destroy */ inline __fastcall virtual ~TsCustomSysMenu() { }
...
public:
	...
	void __fastcall UpdateGlyphs();
	void __fastcall MakeSkinItems();
...
public:
	/* TPopupMenu.Destroy */ inline __fastcall virtual ~TsSystemMenu() { }
...
protected:
	...
	void __fastcall RemoveAllItems();
	void __fastcall CleanItems();
...
public:
	...
	__fastcall virtual ~TacCtrlAdapter();
};
...
public:
	...
	virtual void __fastcall TimeHandler();
public:
	...
	/* TacThreadedTimer.Destroy */ inline __fastcall virtual ~TacMoveTimer() { }
...
extern DELPHI_PACKAGE bool __fastcall AeroIsEnabled();
extern DELPHI_PACKAGE bool __fastcall ForbidSysAnimating();
