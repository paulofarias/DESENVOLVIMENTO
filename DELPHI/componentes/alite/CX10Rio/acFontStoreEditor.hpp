...
// (DO NOT EDIT: machine generated header) 'acFontStoreEditor.pas' rev: 33.00 (Windows)
...
public:
	...
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TFormFontStore() { }
