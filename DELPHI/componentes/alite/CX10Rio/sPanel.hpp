...
// (DO NOT EDIT: machine generated header) 'sPanel.pas' rev: 33.00 (Windows)
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacSideShadow() { }
...
public:
	...
	/* TsCustomPanel.Destroy */ inline __fastcall virtual ~TsPanel() { }
...
public:
	/* TsCustomPanel.Destroy */ inline __fastcall virtual ~TsDragBar() { }
...
public:
	...
	/* TsCustomPanel.Destroy */ inline __fastcall virtual ~TsContainer() { }
...
public:
	...
	virtual void __fastcall Paint();
public:
	/* TsCustomPanel.Destroy */ inline __fastcall virtual ~TsGrip() { }
...
public:
	...
	__fastcall virtual ~TsColorsPanel();
	void __fastcall GenerateColors();
	virtual void __fastcall AfterConstruction();
	...
	virtual void __fastcall WndProc(Winapi::Messages::TMessage &Message);
	DYNAMIC void __fastcall MouseDown(System::Uitypes::TMouseButton Button, System::Classes::TShiftState Shift, int X, int Y);
	System::Uitypes::TColor __fastcall ColorValue();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacColorData1() { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacColorData2() { }
...
public:
	...
	__fastcall virtual ~TacGradPaintData();
	void __fastcall Invalidate();
...
public:
	...
	__fastcall virtual ~TsGradientPanel();
	virtual void __fastcall Loaded();
	virtual void __fastcall Paint();
	virtual bool __fastcall PrepareCache();
	virtual void __fastcall WndProc(Winapi::Messages::TMessage &Message);
...
public:
	...
	/* TsColorsPanel.Destroy */ inline __fastcall virtual ~TsStdColorsPanel() { }
...
protected:
	...
	System::Types::TRect __fastcall BtnRect();
	int __fastcall BtnPaintState();
	bool __fastcall PtInButton(int X, int Y);
	System::Types::TPoint __fastcall PrepareStdCache();
	System::Types::TPoint __fastcall PrepareSkinCache();
	bool __fastcall GlyphExists();
	int __fastcall ActualImageIndex();
	int __fastcall ArrowSquareSize();
	...
	void __fastcall ShowTitleForm();
	void __fastcall HideTitleForm();
	void __fastcall UpdateAngle();
...
public:
	...
	virtual void __fastcall WndProc(Winapi::Messages::TMessage &Message);
	__fastcall virtual ~TsRollOutPanel();
	virtual void __fastcall Loaded();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacBlurData() { }
...
private:
	...
	int __fastcall CompSize();
	void __fastcall AnimationTimerHandler(System::TObject* Sender);
	void __fastcall PrepareBGBmp();
	void __fastcall UpdateBGBmp();
	void __fastcall KillParentBlur();
	bool __fastcall CanAnimate(TacSVState State);
	bool __fastcall CanAutoHide();
	int __fastcall WindowSize();
	int __fastcall GetVisibleSize();
	int __fastcall Position();
	int __fastcall ActualOpenedSize();
...
protected:
	...
	void __fastcall UpdateParentBlur();
	void __fastcall DoClosing();
	void __fastcall DoOpening();
	void __fastcall DoClosed();
	void __fastcall DoOpened();
...
public:
	...
	__fastcall virtual ~TsSplitView();
	virtual void __fastcall Loaded();
