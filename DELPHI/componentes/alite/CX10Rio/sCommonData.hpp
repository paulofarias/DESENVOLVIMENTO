...
// (DO NOT EDIT: machine generated header) 'sCommonData.pas' rev: 33.00 (Windows)
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacOuterEffects() { }
...
protected:
	...
	Sskinmanager::TacSkinData* __fastcall GetCommonSkinData();
...
public:
	...
	__fastcall virtual ~TsCommonData();
	void __fastcall InitCommonProp();
	void __fastcall RemoveCommonProp();
	bool __fastcall RepaintIfMoved();
	void __fastcall ClearLinks();
	void __fastcall Loaded(bool UpdateColors = true);
	NativeUInt __fastcall OwnerHandle();
...
public:
	...
	/* TsCommonData.Destroy */ inline __fastcall virtual ~TsCtrlSkinData() { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacScrollData() { }
...
public:
	...
	__fastcall virtual ~TsScrollWndData();
...
private:
	...
	void __fastcall UpdateAlignment();
	bool __fastcall GetUseSkin();
...
extern DELPHI_PACKAGE void __fastcall InitIndexes(TsCommonData* const SkinData, const System::UnicodeString *Sections, const int Sections_High);
