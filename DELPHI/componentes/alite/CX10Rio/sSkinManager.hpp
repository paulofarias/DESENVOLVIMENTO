...
// (DO NOT EDIT: machine generated header) 'sSkinManager.pas' rev: 33.00 (Windows)
...
public:
	...
	int __fastcall BrightMin();
	int __fastcall BrightMax();
	void __fastcall Init();
	void __fastcall LoadParams();
	void __fastcall LoadAllMasks();
	void __fastcall InitMaskIndexes();
	void __fastcall InitConstantIndexes();
	void __fastcall InitMaskParams();
	void __fastcall LoadAllGeneralData();
	void __fastcall CheckShadows();
	int __fastcall ScaleIntValue(int Value);
	void __fastcall Reset();
	void __fastcall FreeBitmaps();
	void __fastcall ClearBmpArray();
	__fastcall virtual ~TacSkinData();
	Vcl::Graphics::TBitmap* __fastcall GetActiveShadow();
	Vcl::Graphics::TBitmap* __fastcall GetPassiveShadow();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacSkinEffects() { }
...
public:
	__fastcall TacBtnEffects();
	
__published:
	__property Sconst::TacBtnEvents Events = {read=FEvents, write=FEvents, default=15};
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacBtnEffects() { }
...
public:
	__fastcall virtual TacFormAnimation();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacFormAnimation() { }
...
public:
	__fastcall virtual TacBlendOnMoving();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacBlendOnMoving() { }
...
public:
	__fastcall virtual TacMinimizing();
	
__published:
	__property Time = {default=80};
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacMinimizing() { }
...
public:
	/* TacFormAnimation.Create */ inline __fastcall virtual TacFormShow() : TacFormAnimation() { }
	
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacFormShow() { }
...
__published:
	__property Mode = {default=1};
public:
	/* TacFormAnimation.Create */ inline __fastcall virtual TacFormHide() : TacFormAnimation() { }
	
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacFormHide() { }
...
public:
	/* TacFormAnimation.Create */ inline __fastcall virtual TacPageChange() : TacFormAnimation() { }
	
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacPageChange() { }
...
public:
	__fastcall virtual TacDialogShow();
	
__published:
	__property Time = {default=0};
	__property Mode = {default=1};
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacDialogShow() { }
...
public:
	__fastcall virtual TacSkinChanging();
	
__published:
	__property Time = {default=100};
	__property Mode = {default=0};
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacSkinChanging() { }
...
public:
	TsSkinManager* Manager;
	__fastcall TacAnimEffects();
	__fastcall virtual ~TacAnimEffects();
...
public:
	...
	__fastcall virtual ~TsStoredSkin();
...
public:
	TsStoredSkin* operator[](int Index) { return this->Items[Index]; }
...
public:
	...
	__fastcall virtual ~TsStoredSkins();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TsThirdPartyList() { }
	
public:
	/* TObject.Create */ inline __fastcall TsThirdPartyList() : System::Classes::TPersistent() { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacScrollBarsSupport() { }
...
private:
	...
	bool __fastcall GetOldGlyphsMode();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacButtonsSupport() { }
...
private:
	...
	Sconst::TacScaleMode __fastcall GetScaleMode();
...
public:
	Acnttypes::TacArrowsStyle __fastcall ActualArrowStyle();
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacOptions() { }
...
public:
	...
	__fastcall virtual ~TacAddThread();
	virtual void __fastcall Execute();
	void __fastcall DoTimer();
public:
	/* TThread.Create */ inline __fastcall TacAddThread()/* overload */ : System::Classes::TThread() { }
	/* TThread.Create */ inline __fastcall TacAddThread(bool CreateSuspended)/* overload */ : System::Classes::TThread(CreateSuspended) { }
	/* TThread.Create */ inline __fastcall TacAddThread(bool CreateSuspended, NativeUInt ReservedStackSize)/* overload */ : System::Classes::TThread(CreateSuspended, ReservedStackSize) { }
...
public:
	...
	__fastcall virtual ~TacSkinListController();
};
...
public:
	...
	__fastcall virtual ~TacSkinConvertor();
public:
	/* TObject.Create */ inline __fastcall TacSkinConvertor() : System::Classes::TPersistent() { }
...
public:
	/* TPersistent.Destroy */ inline __fastcall virtual ~TacFonts() { }
...
private:
	...
	void __fastcall UpdateCurrentSkin();
	...
	TacSkinInfo __fastcall GetSkinInfo();
	bool __fastcall GetExtendedBorders();
...
protected:
	...
	void __fastcall SendRemoveSkin();
	void __fastcall InitCommonData();
...
public:
	...
	void __fastcall ResetSkinData();
	void __fastcall ClearSkinData();
	void __fastcall LoadFonts();
	void __fastcall LoadCommonData();
	void __fastcall InitSkinParams();
	bool __fastcall InitSkinFile();
	void __fastcall CloseSkinFile();
	void __fastcall FlipImages(bool RTL);
	void __fastcall ReloadSkin(int PPI = 0x60);
	void __fastcall CheckVersion();
	...
	System::UnicodeString __fastcall GetFullSkinDirectory();
	System::UnicodeString __fastcall GetRandomSkin();
	int __fastcall LengthOfGD();
	...
	System::Uitypes::TColor __fastcall GetGlobalColor();
	System::Uitypes::TColor __fastcall GetGlobalFontColor();
	System::Uitypes::TColor __fastcall GetActiveEditColor();
	System::Uitypes::TColor __fastcall GetActiveEditFontColor();
	...
	void __fastcall UpdateAllScale();
	void __fastcall InstallHook();
	void __fastcall UnInstallHook();
