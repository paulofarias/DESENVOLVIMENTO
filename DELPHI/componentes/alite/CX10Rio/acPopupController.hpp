...
// (DO NOT EDIT: machine generated header) 'acPopupController.pas' rev: 33.00 (Windows)
...
protected:
	...
	void __fastcall UnInitControls();
...
public:
	...
	__fastcall virtual ~TacFormHandler();
};
...
public:
	...
	__fastcall virtual ~TsPopupController();
};


//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE TsPopupController* acIntController;
extern DELPHI_PACKAGE TsPopupController* __fastcall GetIntController();
