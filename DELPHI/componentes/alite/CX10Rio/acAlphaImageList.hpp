...
// (DO NOT EDIT: machine generated header) 'acAlphaImageList.pas' rev: 33.00 (Windows)
...
public:
	...
	__fastcall virtual ~TsImgListItem();
...
public:
	TsImgListItem* operator[](int Index) { return this->Items[Index]; }
...
public:
	...
	__fastcall virtual ~TsImgListItems();
...
public:
	...
	__fastcall virtual ~TacImageList();
...
private:
	...
	HIDESBASE System::Uitypes::TColor __fastcall GetBkColor();
...
public:
	...
	__fastcall virtual ~TsAlphaImageList();
	void __fastcall UpdateFromStd();
	void __fastcall GenerateStdList();
...
private:
	...
	TsCharImageList* __fastcall ImgList();
	void __fastcall SetScalingFactor(const double Value);
	bool __fastcall NotDefScaling();
	bool __fastcall NotDefFont();
	bool __fastcall NotEmptyAdded();
...
public:
	...
	__fastcall virtual ~TacCharListItem();
...
public:
	TacCharListItem* operator[](int Index) { return this->Items[Index]; }
...
protected:
	...
	DYNAMIC System::Classes::TPersistent* __fastcall GetOwner();
	void __fastcall CheckItems();
	
public:
	__fastcall TacCharListItems(TsCharImageList* AOwner);
	__fastcall virtual ~TacCharListItems();
...
public:
	virtual void __fastcall Assign(System::Classes::TPersistent* Source);
	__fastcall virtual ~TacEmbeddedFonts();
...
protected:
	...
	void __fastcall UnLoadAllFonts();
	void __fastcall LoadAllFonts();
...
public:
	...
	__fastcall virtual ~TsCharImageList();
	void __fastcall GenerateStdList();
	virtual bool __fastcall GetBitmap32(int Index, Vcl::Graphics::TBitmap* Image, int GlyphHeight = 0x0);
	virtual Vcl::Graphics::TBitmap* __fastcall CreateBitmap32(int Index, int aWidth, int aHeight, int GlyphHeight = 0x0);
