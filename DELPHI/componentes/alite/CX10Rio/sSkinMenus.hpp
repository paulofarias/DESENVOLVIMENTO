...
// (DO NOT EDIT: machine generated header) 'sSkinMenus.pas' rev: 33.00 (Windows)
...
private:
	...
	bool __fastcall ExtraFontStored();
	bool __fastcall LineSkinStored();
	
public:
	__fastcall TacMenuSupport();
	__fastcall virtual ~TacMenuSupport();
...
private:
	...
	Vcl::Graphics::TFont* __fastcall GetCaptionFont();
...
protected:
	...
	int __fastcall CursorMarginH();
	int __fastcall CursorMarginV();
...
public:
	...
	__fastcall virtual ~TsSkinableMenus();
...
extern DELPHI_PACKAGE bool __fastcall ChildIconPresent();
...
extern DELPHI_PACKAGE void __fastcall ClearCache();
}	/* namespace Sskinmenus */
