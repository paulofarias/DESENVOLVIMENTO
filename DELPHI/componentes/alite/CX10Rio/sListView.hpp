...
// (DO NOT EDIT: machine generated header) 'sListView.pas' rev: 33.00 (Windows)
...
protected:
	...
	int __fastcall HeaderOffset();
	void __fastcall InitSkinParams();
	bool __fastcall FullRepaint();
	...
	void __fastcall InvalidateSmooth();
...
public:
	...
	__fastcall virtual ~TsCustomListView();
	virtual void __fastcall Invalidate();
	void __fastcall UpdateAutoSize();
...
public:
	...
	/* TsCustomListView.Destroy */ inline __fastcall virtual ~TsListView() { }
...
public:
	...
	/* TListItems.Destroy */ inline __fastcall virtual ~TsHackedListItems() { }
