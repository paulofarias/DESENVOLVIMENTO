...
// (DO NOT EDIT: machine generated header) 'sInternalSkins.pas' rev: 33.00 (Windows)
...
public:
	...
	void __fastcall AddNewSkin();
	void __fastcall UpdateMyActions();
...
public:
	...
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TFormInternalSkins() { }
