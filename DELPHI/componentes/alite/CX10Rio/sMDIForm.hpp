...
// (DO NOT EDIT: machine generated header) 'sMDIForm.pas' rev: 33.00 (Windows)
...
public:
	...
	void __fastcall ConnectToClient();
	__fastcall TsMDIForm(System::Classes::TPersistent* AOwner);
	__fastcall virtual ~TsMDIForm();
	Vcl::Menus::TMenuItem* __fastcall MakeChildIconItem();
	void __fastcall UpdateMDIIconItem();
	void __fastcall RefreshMDIScrolls();
	void __fastcall DestroyScrolls();
