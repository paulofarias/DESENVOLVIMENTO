...
// (DO NOT EDIT: machine generated header) 'sCheckBox.pas' rev: 33.00 (Windows)
...
protected:
	...
	void __fastcall PaintStdBG();
	bool __fastcall CustomGlyph();
	void __fastcall DrawCheckText();
	void __fastcall DrawCheckArea();
	void __fastcall DrawSkinGlyph(int i);
	int __fastcall PaintCtrlState();
	...
	Vcl::Graphics::TBitmap* __fastcall Glyph();
	System::Types::TSize __fastcall CheckSize();
	System::Types::TRect __fastcall CheckRect(bool LeftAligned);
	System::Types::TSize __fastcall CustomGlyphSize();
