...
// (DO NOT EDIT: machine generated header) 'sComboBoxes.pas' rev: 33.00 (Windows)
...
private:
	...
	Vcl::Comctrls::TComboExItem* __fastcall GetSelectedItem();
...
protected:
	...
	virtual bool __fastcall AllowDropDown();
	bool __fastcall AllowBtnStyle();
	int __fastcall BrdWidth();
...
public:
	__fastcall virtual ~TsCustomComboBoxEx();
...
public:
	/* TsCustomComboBoxEx.Destroy */ inline __fastcall virtual ~TsComboBoxEx() { }
...
public:
	...
	virtual void __fastcall WndProc(Winapi::Messages::TMessage &Message);
public:
	/* TsSpeedButton.Destroy */ inline __fastcall virtual ~TacSkinSelectBtn() { }
...
protected:
	...
	void __fastcall InitFormData();
	void __fastcall UpdateBoxSize();
	void __fastcall UpdateControls();
	void __fastcall UpdateHotControl();
	void __fastcall SetBtnIndex(int NewIndex);
	void __fastcall ClickBtn(TacSkinSelectBtn* AButton);
	
public:
	__fastcall virtual ~TacSkinSelectForm();
...
protected:
	void __fastcall UpdateItemIndex();
...
public:
	...
	virtual void __fastcall DoDropDown();
	__fastcall virtual ~TsSkinSelector();
	HIDESBASE bool __fastcall DroppedDown();
	virtual void __fastcall CreateWnd();
