...
// (DO NOT EDIT: machine generated header) 'ac3rdPartyEditor.pas' rev: 33.00 (Windows)
...
public:
	...
	/* TCustomForm.Destroy */ inline __fastcall virtual ~TForm3rdPartyEditor() { }
