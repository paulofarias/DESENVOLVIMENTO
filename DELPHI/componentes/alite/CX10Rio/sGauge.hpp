...
// (DO NOT EDIT: machine generated header) 'sGauge.pas' rev: 33.00 (Windows)
...
private:
	...
	__int64 __fastcall GetPercentDone();
...
protected:
	...
	int __fastcall AnimSize();
	int __fastcall AnimStep();
	void __fastcall UpdateLighting();
	
public:
	virtual void __fastcall Paint();
	void __fastcall PrepareCache();
	__fastcall virtual TsGauge(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TsGauge();
