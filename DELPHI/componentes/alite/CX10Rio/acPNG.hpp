...
// (DO NOT EDIT: machine generated header) 'acPNG.pas' rev: 33.00 (Windows)
...
protected:
	...
	void __fastcall CreateYCbCrLookup();
	Vcl::Graphics::TPixelFormat __fastcall GetPixelFormat(int Index);
	void __fastcall PrepareConversion();
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TColorManager() { }
...
private:
	...
	int FFlushMode;
	bool FAutoReset;
	int __fastcall GetAvailableInput();
	int __fastcall GetAvailableOutput();
...
public:
	/* TObject.Destroy */ inline __fastcall virtual ~TLZ77Decoder() { }
...
private:
	...
	unsigned __fastcall LoadAndSwapHeader();
	...
	void __fastcall ReadDataAndCheckCRC();
	
public:
	bool Reflected;
	__fastcall virtual TPNGGraphic();
	__fastcall virtual ~TPNGGraphic();
