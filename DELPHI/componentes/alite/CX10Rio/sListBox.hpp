...
// (DO NOT EDIT: machine generated header) 'sListBox.pas' rev: 33.00 (Windows)
...
public:
	...
	__fastcall virtual ~TsCustomListBox();
...
public:
	...
	/* TsCustomListBox.Destroy */ inline __fastcall virtual ~TsListBox() { }
