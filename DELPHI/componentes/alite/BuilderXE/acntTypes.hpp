...
// (DO NOT EDIT: machine generated header) 'acntTypes.pas' rev: 22.00
...
typedef System::DynamicArray<Controls::TControl*> TacCtrlArray;
...
class PASCALIMPLEMENTATION TacAccessCanvas : public Graphics::TCustomCanvas
{
...
public:
	/* TObject.Create */ inline __fastcall TacAccessCanvas(void) : Graphics::TCustomCanvas() { }
