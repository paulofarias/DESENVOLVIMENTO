...
// (DO NOT EDIT: machine generated header) 'Acalphaimagelist.pas' rev: 20.00
...
private:
	typedef DynamicArray<Graphics::TBitmap*> _TsVirtualImageList__1;
...
extern PACKAGE double __fastcall GetDefScaling(Graphics::TFontCharset CharSet, const System::UnicodeString FontName);
