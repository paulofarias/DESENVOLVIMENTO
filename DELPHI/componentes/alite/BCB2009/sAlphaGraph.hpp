...
// (DO NOT EDIT: machine generated header) 'Salphagraph.pas' rev: 20.00
...
extern PACKAGE void __fastcall UpdateCorners(Scommondata::TsCommonData* SkinData, int State, TsCorners Corners = (TsCorners() << scLeftTop << scLeftBottom << scRightTop << scRightBottom ));
