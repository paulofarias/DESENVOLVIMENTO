...
{
//-- type declarations -------------------------------------------------------
typedef StaticArray<StaticArray<System::UnicodeString, 4>, 4> Sskinprops__1;

typedef StaticArray<System::UnicodeString, 4> Sskinprops__2;

typedef StaticArray<System::UnicodeString, 4> Sskinprops__3;

typedef StaticArray<System::UnicodeString, 4> Sskinprops__4;

typedef StaticArray<System::UnicodeString, 2> Sskinprops__5;

typedef StaticArray<System::UnicodeString, 2> Sskinprops__6;

typedef StaticArray<System::UnicodeString, 3> Sskinprops__7;

typedef StaticArray<System::UnicodeString, 3> Sskinprops__8;
