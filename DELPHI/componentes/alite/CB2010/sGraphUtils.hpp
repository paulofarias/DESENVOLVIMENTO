...
// (DO NOT EDIT: machine generated header) 'Sgraphutils.pas' rev: 21.00
...
typedef StaticArray<Sysutils::PByteArray, 1000001> TByteArrays;
...
extern PACKAGE int __fastcall PaintSection(const Graphics::TBitmap* Bmp, const System::UnicodeString Section, const System::UnicodeString SecondSection, const int State, const Acnttypes::TacObject* CommonSkinData, const Types::TPoint &ParentOffset, const Graphics::TColor BGColor, HDC ParentDC = (HDC)(0x0))/* overload */;
...
extern PACKAGE bool __fastcall acExtTextOut(HDC DC, int X, int Y, int Options, Types::PRect Rect, System::WideChar * Str, int Count, System::PInteger Dx);
...
extern PACKAGE void __fastcall acWriteTextEx(const Graphics::TCanvas* Canvas, const System::WideChar * Text, const bool Enabled, Types::TRect &aRect, const unsigned Flags, const Scommondata::TsCommonData* SkinData, const bool Hot, const System::TObject* SkinManager = (System::TObject*)(0x0), bool CanGlow = true)/* overload */;
...
extern PACKAGE void __fastcall WriteTextEx(const Graphics::TCanvas* Canvas, System::WideChar * Text, bool Enabled, Types::TRect &aRect, unsigned Flags, Scommondata::TsCommonData* SkinData, bool Hot, System::TObject* SkinManager = (System::TObject*)(0x0), bool CanGlow = true)/* overload */;
...
extern PACKAGE void __fastcall PaintBmpRect32(const Graphics::TBitmap* DstBmp, const Graphics::TBitmap* SrcBmp, const Types::TRect &SrcRect, const Types::TPoint &DstPoint, System::Byte SrcBlendValue = (System::Byte)(0xff));
extern PACKAGE void __fastcall StretchBmpRect32(const Graphics::TBitmap* DstBmp, int XDst, int YDst, int DstWidth, int DstHeight, Graphics::TBitmap* SrcBmp, int XSrc, int YSrc, int SrcWidth, int SrcHeight, System::Byte SrcBlendValue = (System::Byte)(0xff));
...
extern PACKAGE bool __fastcall FontSizeIsNear(const Graphics::TFont* BaseFont, const System::UnicodeString TestText, const System::UnicodeString FontName);
extern PACKAGE tagSIZE __fastcall GetStringSize(HGDIOBJ hFont, const System::UnicodeString Text, unsigned Flags = (unsigned)(0x0), bool WrapText = false, int MaxWidth = 0x7fffffff, bool IsItalic = false);
