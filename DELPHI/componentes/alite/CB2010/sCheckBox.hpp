...
// (DO NOT EDIT: machine generated header) 'Scheckbox.pas' rev: 21.00
...
protected:
	...
	tagSIZE __fastcall CheckSize(void);
	Types::TRect __fastcall CheckRect(bool LeftAligned);
	tagSIZE __fastcall CustomGlyphSize(void);
