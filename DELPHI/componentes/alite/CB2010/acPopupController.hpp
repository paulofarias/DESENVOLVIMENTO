...
// (DO NOT EDIT: machine generated header) 'Acpopupcontroller.pas' rev: 21.00
...
private:
	typedef DynamicArray<TacFormHandler*> _TsPopupController__1;
...
protected:
	...
	void __fastcall AnimShowPopup(Forms::TForm* aForm, System::Word wTime = (System::Word)(0x0), System::Byte BlendValue = (System::Byte)(0xff));
