...
// (DO NOT EDIT: machine generated header) 'acAlphaImageList.pas' rev: 23.00 (Win32)
...
enum TsImageFormat : unsigned char { ifPNG, ifICO, ifBMP32 };
#pragma option pop
...
public:
	...
	void __fastcall LoadFromPngStream(const System::Classes::TStream* Stream);
...
#pragma option push -b-
enum TacBlendingMode : unsigned char { bmInactive, bmAlways };
#pragma option pop
...
extern PACKAGE bool __fastcall GetImageFormat(const System::Classes::TStream* Stream, TsImageFormat &ImageFormat)/* overload */;
extern PACKAGE System::Types::TSize __fastcall DrawAlphaImgList(const Vcl::Imglist::TCustomImageList* ImgList, const Vcl::Graphics::TBitmap* DestBmp, const int Left, const int Top, const int ImageIndex, const int Blend, const System::Uitypes::TColor GrayedColor, const int State, const int NumGlyphs, const bool Reflected, int PPI);
extern PACKAGE void __fastcall DrawAlphaImgListDC(const Vcl::Imglist::TCustomImageList* ImgList, const HDC DC, const int Left, const int Top, const int ImageIndex, const int Blend, const System::Uitypes::TColor GrayedColor, const int State, const int NumGlyphs, const bool Reflected, int PPI = 0x60);
extern PACKAGE double __fastcall GetDefScaling(System::Uitypes::TFontCharset CharSet, const System::UnicodeString FontName);
extern PACKAGE void __fastcall SetImagesPPI(Vcl::Imglist::TCustomImageList* ImgList, const int PPI);
extern PACKAGE void __fastcall SetImagesState(Vcl::Imglist::TCustomImageList* ImgList, const int AState);
extern PACKAGE void __fastcall ClearImgListCache(Vcl::Imglist::TCustomImageList* ImgList, int ImgIndex = 0xffffffff);
