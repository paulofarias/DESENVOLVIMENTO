...
// (DO NOT EDIT: machine generated header) 'sScrollBar.pas' rev: 23.00 (Win32)
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE bool __fastcall UpdateControlScrollBar(Vcl::Controls::TWinControl* Control, TsScrollBar* &ScrollBar, Vcl::Forms::TScrollBarKind Kind, bool Free = true);
