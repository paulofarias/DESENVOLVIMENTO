...
// (DO NOT EDIT: machine generated header) 'acThdTimer.pas' rev: 23.00 (Win32)
...
extern PACKAGE int __fastcall GetNewTimer(TacThreadedTimer* &ATimer, System::Classes::TComponent* AOwner, int State);
