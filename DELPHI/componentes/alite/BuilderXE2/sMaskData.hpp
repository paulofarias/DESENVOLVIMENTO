...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE System::Types::TSize __fastcall MkSize(const TsMaskData &md)/* overload */;
extern PACKAGE bool __fastcall ScaleMaskData(TsMaskData &md, const Vcl::Graphics::TBitmap* MasterBmp, bool IgnoreFuchsia);
