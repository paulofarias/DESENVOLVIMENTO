...
extern PACKAGE void __fastcall acgpFillEllipse(HDC DC, float X, float Y, float Width, float Height, System::Uitypes::TColor Color);
...
extern PACKAGE void __fastcall acgpStretchRect(Vcl::Graphics::TBitmap* DstBmp, Vcl::Graphics::TBitmap* SrcBmp, int SrcX, int SrcY, int SrcWidth, int SrcHeight)/* overload */;
extern PACKAGE void __fastcall acgpStretchRect(Vcl::Graphics::TBitmap* DstBmp, Vcl::Graphics::TBitmap* SrcBmp, const System::Types::TRect &DstRect, const System::Types::TRect &SrcRect)/* overload */;
extern PACKAGE void __fastcall acgpBlur(Vcl::Graphics::TBitmap* Bmp, float Radius);
...
extern PACKAGE void __fastcall acgpGradientRectangle(HDC DC, float X, float Y, float Width, float Height, System::Types::TPoint const *Points, Sconst::TsColor const *Colors, const Sconst::TsColor CenterColor);
extern PACKAGE System::UnicodeString __fastcall acgpGetFontName(const System::UnicodeString FileName);
extern PACKAGE void __fastcall acgpDrawPolygon(HDC DC, System::Uitypes::TColor Color, PacPointF Points, int PointCount, int LineWidth = 0x1);
extern PACKAGE void __fastcall acgpDrawBeziers(HDC DC, System::Uitypes::TColor Color, PacPointF Points, int PointCount, int LineWidth = 0x1);
extern PACKAGE void __fastcall acgpFillPolygon(HDC DC, System::Uitypes::TColor Color, PacPointF Points, int PointCount);
extern PACKAGE void __fastcall acgpRotatePoints(PacGpPoints ARect, const TacPointF &ACenter, int ACount, int Angle);
extern PACKAGE void __fastcall acgpDrawRotatedBitmap(HDC DC, Vcl::Graphics::TBitmap* SrcBmp, const System::Types::TRect &R, int Angle);
