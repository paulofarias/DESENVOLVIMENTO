...
#pragma option push -b-
enum TacAnimTypeCtrl : unsigned char { atcFade, atcAero, atcBlur, atcBlur2, atcRunup };
#pragma option pop
...
#pragma option push -b-
enum TacScaleMode : unsigned char { sm100, sm125, sm150, sm200, smAuto, smOldMode, smVCL, smCustomPPI };
#pragma option pop
...
#pragma option push -b-
enum TsCaptionLayout : unsigned char { sclLeft, sclTopLeft, sclTopCenter, sclTopRight, sclLeftTop, sclBottomLeft, sclBottomCenter, sclBottomRight, sclRight, sclRightTop, sclLeftLeft, sclRightRight };
#pragma option pop
