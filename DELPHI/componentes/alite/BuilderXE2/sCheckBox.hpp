...
// (DO NOT EDIT: machine generated header) 'sCheckBox.pas' rev: 23.00 (Win32)
...
private:
	...
	void __fastcall SetGlyphChecked(const Vcl::Graphics::TBitmap* Value);
	void __fastcall SetGlyphUnChecked(const Vcl::Graphics::TBitmap* Value);
