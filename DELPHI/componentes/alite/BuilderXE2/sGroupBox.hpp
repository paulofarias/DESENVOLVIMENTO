...
// (DO NOT EDIT: machine generated header) 'sGroupBox.pas' rev: 23.00 (Win32)
...
enum TsCaptionLayout : unsigned char { clTopLeft, clTopCenter, clTopRight };
#pragma option pop

#pragma option push -b-
enum TacChangeState : unsigned char { csNone, csAsChecked, csAsNotChecked };
#pragma option pop

#pragma option push -b-
enum TacBoxStyle : unsigned char { bsDefault, bsStandard, bsCard };
#pragma option pop
