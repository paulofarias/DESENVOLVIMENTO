...
// (DO NOT EDIT: machine generated header) 'sPropEditors.pas' rev: 23.00 (Win32)
...
extern PACKAGE void __fastcall EditPropertyWithDialog(System::Classes::TPersistent* Component, const System::AnsiString PropName, const Designintf::_di_IDesigner Designer);
