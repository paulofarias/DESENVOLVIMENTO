...
extern PACKAGE void __fastcall ac_DrawScrollBtn(const System::Types::TRect &bRect, int State, Vcl::Graphics::TBitmap* Bmp, Sskinmanager::TacSkinData* sd, Sconst::TacSide Side);
extern PACKAGE void __fastcall ac_DrawSlider(const System::Types::TRect &bRect, int State, Vcl::Graphics::TBitmap* Bmp, Sskinmanager::TacSkinData* sd, bool Vert);
...
extern PACKAGE System::Types::TRect __fastcall BtnDrawRect(const System::Types::TRect &R, Sskinmanager::TacSkinData* sd, Sconst::TacSide Side);
