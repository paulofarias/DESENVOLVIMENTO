...
// (DO NOT EDIT: machine generated header) 'sComboBoxes.pas' rev: 23.00 (Win32)
...
enum TacUpdateFlags : unsigned char { ufUpdateThumbs, ufUpdateScale, ufFormCreating, ufFormInitializing };
#pragma option pop
...
#pragma option push -b-
enum TacThumbSize : unsigned char { tsSmall, tsMedium, tsBig };
#pragma option pop
