...
// (DO NOT EDIT: machine generated header) 'sSkinProvider.pas' rev: 23.00 (Win32)
...
enum TacAnimEvent : unsigned char { aeShowing, aeHiding, aeSkinChanging };
#pragma option pop

#pragma option push -b-
enum TsGripMode : unsigned char { gmNone, gmRightBottom };
#pragma option pop

#pragma option push -b-
enum TsResizeMode : unsigned char { rmStandard, rmBorder };
#pragma option pop
...
#pragma option push -b-
enum TacMenuItemPos : unsigned char { ipTop, ipBottom, ipBeforeClose };
#pragma option pop
...
private:
	...
	void __fastcall SetGluedForms(const System::Classes::TStringList* Value);
...
protected:
	...
	void __fastcall InitLabel(const Vcl::Controls::TControl* Control, const bool Skinned);
...
public:
	...
	void __fastcall ProcessMessage(unsigned Msg, unsigned WPar = (unsigned)(0x0), int LPar = (int)(0x0));
...
public:
	...
	void __fastcall AddNewItem(const Vcl::Buttons::TSpeedButton* Ctrl)/* overload */;
	void __fastcall AddNewItem(const Vcl::Controls::TWinControl* Ctrl)/* overload */;
	void __fastcall AddNewItem(const Vcl::Controls::TWinControl* Ctrl, const System::UnicodeString SkinSection)/* overload */;
...
extern PACKAGE Vcl::Graphics::TBitmap* __fastcall GetFormImage(TsSkinProvider* sp, bool CacheReplaced = false);
...
extern PACKAGE System::Types::TPoint __fastcall SkinMenuOffset(const TsSkinProvider* sp);
...
extern PACKAGE TsSkinProvider* __fastcall GetSkinProvider(System::Classes::TComponent* Cmp);
