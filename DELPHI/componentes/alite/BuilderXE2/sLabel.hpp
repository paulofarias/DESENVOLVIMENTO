...
// (DO NOT EDIT: machine generated header) 'sLabel.pas' rev: 23.00 (Win32)
...
enum TsShadowMode : unsigned char { smNone, smCustom, smSkin1 };
#pragma option pop

#pragma option push -b-
enum TsKindType : unsigned char { ktStandard, ktCustom, ktSkin };
#pragma option pop
...
private:
	...
	void __fastcall SetHoverFont(const Vcl::Graphics::TFont* Value);
	void __fastcall SetNormalFont(const Vcl::Graphics::TFont* Value);
...
#pragma option push -b-
enum TAlignTo : unsigned char { altLeft, altTop, altBottom, altRight, altTopCenter, altBottomCenter };
#pragma option pop
