...
// (DO NOT EDIT: machine generated header) 'sButton.pas' rev: 23.00 (Win32)
...
enum TButtonStyle : unsigned char { bsPushButton, bsCommandLink, bsSplitButton };
#pragma option pop
...
private:
	...
	void __fastcall SetCommandLinkFont(const Vcl::Graphics::TFont* Value);
	Vcl::Imglist::TImageIndex __fastcall GetImageIndex(void);
	HIDESBASE void __fastcall SetImageIndex(const Vcl::Imglist::TImageIndex Value);
...
__published:
	...
	__property Vcl::Imglist::TImageIndex ImageIndex = {read=GetImageIndex, write=SetImageIndex, stored=IsImageIndexStored, default=-1};
