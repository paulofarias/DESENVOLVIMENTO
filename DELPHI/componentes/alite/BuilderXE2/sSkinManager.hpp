...
// (DO NOT EDIT: machine generated header) 'sSkinManager.pas' rev: 23.00 (Win32)
...
enum TacFileType : unsigned char { ftBmp, ftFont, ftOther };
#pragma option pop
...
#pragma option push -b-
enum TacSkinMode : unsigned char { smInternal, smExtPacked, smExtUnpacked };
#pragma option pop
...
protected:
	...
	void __fastcall AddImage(const Vcl::Graphics::TBitmap* Bmp, const System::UnicodeString s, const System::UnicodeString sPropName, const System::Types::TRect &R, const System::Types::TRect &SrcRect, int SrcPPI, int iMaskType);
...
#pragma option push -b-
enum TacSkinTypes : unsigned char { stUnpacked, stPacked, stAllSkins };
#pragma option pop

#pragma option push -b-
enum TacSkinPlaces : unsigned char { spInternal, spExternal, spAllPlaces };
#pragma option pop
...
#pragma option push -b-
enum TacModalButtonsColoringValue : unsigned char { bcBackground, bcGlyph, bcText };
#pragma option pop
...
#pragma option push -b-
enum TacGroupBoxStyle : unsigned char { gsStandard, gsCard };
#pragma option pop
...
#pragma option push -b-
enum TacSkinsFilterItem : unsigned char { sfiInternal, sfiExternal };
#pragma option pop
...
#pragma option push -b-
enum TacFontMode : unsigned char { fmDefault, fmFromSkin, fmCustom };
#pragma option pop
...
#pragma option push -b-
enum TacManagerStateValue : unsigned char { msFontChanging, msScaleChanging, msSkinRemoving, msSkinChanging, msBroadCasting, msAnimScaling, msFormScaling, msRTLFlipped };
#pragma option pop
...
private:
	...
	void __fastcall SetKeyList(const System::Classes::TStringList* Value);
	void __fastcall SetBuiltInSkins(const TsStoredSkins* Value);
	void __fastcall SetActiveGraphControl(const Vcl::Controls::TGraphicControl* Value);
	void __fastcall SetSkinningRules(const TacSkinningRules Value);
	void __fastcall SetCommonSections(const System::Classes::TStringList* Value);
	void __fastcall SetInteger(const int Index, const int Value);
...
extern PACKAGE System::Classes::TStringList* acEditorSkinFile;
extern PACKAGE TsSkinManager* DefaultManager;
extern PACKAGE bool UnPackedFirst;
extern PACKAGE System::StaticArray<TacSkinData*, 4> StdScaleArray;
...
extern PACKAGE void __fastcall LoadSkinFromFile(const System::UnicodeString FileName, TacSkinConvertor* &Convertor, System::Classes::TStringList* pwds, System::Classes::TComponent* SkinManager);
...
extern PACKAGE System::Uitypes::TColor __fastcall SysColorToSkin(const System::Uitypes::TColor AColor, TsSkinManager* ASkinManager = (TsSkinManager*)(0x0));
...
extern PACKAGE int __fastcall CurrentPPI(TsSkinManager* sm, Vcl::Controls::TControl* OwnerCtrl, bool CheckActive = false);
...
extern PACKAGE bool __fastcall ExtractPackedData(TacSkinConvertor* &Convertor, System::Classes::TStringList* pwds, System::Classes::TComponent* SkinManager);
extern PACKAGE bool __fastcall GetPreviewStream(System::Classes::TMemoryStream* aStream, const System::UnicodeString SkinFileName)/* overload */;
extern PACKAGE bool __fastcall GetPreviewStream(System::Classes::TMemoryStream* aStream, System::Classes::TMemoryStream* SrcStream)/* overload */;
extern PACKAGE bool __fastcall GetPreviewImage(Vcl::Graphics::TBitmap* aBitmap, const System::UnicodeString SkinFileName);
