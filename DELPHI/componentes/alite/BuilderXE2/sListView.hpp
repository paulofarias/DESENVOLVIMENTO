...
// (DO NOT EDIT: machine generated header) 'sListView.pas' rev: 23.00 (Win32)
...
protected:
	...
	bool __fastcall ItemIsHot(const Vcl::Comctrls::TListItem* Item, const System::Types::TRect &R);
	__property BorderStyle = {default=1};
	unsigned __fastcall MakeDragImage(const Winapi::Messages::TMessage &Message);
