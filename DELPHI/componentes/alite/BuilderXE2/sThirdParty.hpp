...
extern PACKAGE int __fastcall GetImageWidth(Vcl::Imglist::TCustomImageList* ImgList, int ImageIndex = 0xffffffff, int PPI = 0x60, bool UseAngle = false);
extern PACKAGE int __fastcall GetImageHeight(Vcl::Imglist::TCustomImageList* ImgList, int ImageIndex = 0xffffffff, int PPI = 0x60, bool UseAngle = false);
extern PACKAGE void __fastcall acDrawGlyphEx(const TacDrawGlyphData &DrawData);
extern PACKAGE void __fastcall DrawBtnGlyph(Vcl::Controls::TControl* Button, Vcl::Graphics::TCanvas* Canvas, System::Uitypes::TColor ColorTone);
