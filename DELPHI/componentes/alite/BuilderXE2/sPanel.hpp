...
enum TacSideShadowMode : unsigned char { ssmNone, ssmInternal };
#pragma option pop
...
#pragma option push -b-
enum TacSVDisplayMode : unsigned char { svmaDocked, svmaOverlay };
#pragma option pop

#pragma option push -b-
enum TacSVCloseStyle : unsigned char { svcaCollapse, svcaCompact };
#pragma option pop

#pragma option push -b-
enum TacSVPlacement : unsigned char { svpaLeft, svpaRight, svpaTop, svpaBottom };
#pragma option pop

#pragma option push -b-
enum TacSVState : unsigned char { svsaOpened, svsaOpening, svsaClosed, svsaClosing };
#pragma option pop

#pragma option push -b-
enum TacSVBlurMode : unsigned char { bmNone, bmSplitView, bmParent };
#pragma option pop
