...
// (DO NOT EDIT: machine generated header) 'sTrackBar.pas' rev: 23.00 (Win32)
...
private:
	...
	void __fastcall SetThumbGlyph(const Vcl::Graphics::TBitmap* Value);
...
enum TacChangingMode : unsigned char { cmDepended, cmUndepended, cmIgnoredSecond };
#pragma option pop
